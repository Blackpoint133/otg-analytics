...
function Invoke-RollbackCore {
    ...
    $oldPython=if($manifest.old_process_executable -and $manifest.old_process_executable -ne 'simulation'){$manifest.old_process_executable}else{$Context.ReleasePython}
    if($Context.Mode -eq 'PRODUCTION') {
