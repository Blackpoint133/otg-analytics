...
def _sales_trader_overlay_css() -> str:
    return '<style>.sales-trader-identity-trigger{color:#FF003A!important;background:transparent!important;border:0!important;box-shadow:none!important;border-radius:0!important;padding:0!important;margin:0!important;min-height:0!important;height:auto!important;appearance:none;-webkit-appearance:none;font:inherit;line-height:inherit;cursor:pointer}.sales-trader-identity-trigger:hover,.sales-trader-identity-trigger:focus-visible{color:#FFF!important;text-decoration:underline}.sales-trader-card-overlay{position:fixed;z-index:10000;width:746px;max-width:calc(100vw - 32px);max-height:calc(100vh - 32px);overflow:auto}.sales-trader-card-overlay .trader-profile-card{width:100%;max-width:none}.sales-trader-card-overlay[hidden]{display:none}@media (max-width:768px){.sales-trader-card-overlay{width:calc(100vw - 24px);max-width:calc(100vw - 24px)}}</style>'
