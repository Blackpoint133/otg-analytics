...
.otg-nav-analytics{{position:relative}}.otg-nav-analytics>summary{{list-style:none}}.otg-nav-analytics>summary::-webkit-details-marker{{display:none}}.otg-nav-analytics>summary.active{{color:#FFFFFF;border-color:#FF003A;border-bottom:2px solid #FF003A;background:rgba(255,0,58,.04)}}
