...
.otg-top-nav-control{{height:34px;box-sizing:border-box;display:inline-flex;align-items:center;justify-content:center;padding:0 14px;background:transparent;border:1px solid transparent;border-radius:0;font-family:'PP Supply Sans','Space Mono',monospace,sans-serif;font-size:10px;font-weight:700;line-height:1;letter-spacing:1px;text-transform:uppercase;white-space:nowrap;color:#9EA3AA;text-decoration:none!important;text-shadow:none;transform:none;cursor:pointer;transition:color 180ms cubic-bezier(.2,.7,.2,1),background-color 180ms cubic-bezier(.2,.7,.2,1),text-shadow 180ms cubic-bezier(.2,.7,.2,1),opacity 180ms cubic-bezier(.2,.7,.2,1)}}
a.otg-top-nav-control:link,a.otg-top-nav-control:visited{{color:#9EA3AA!important;text-decoration:none!important}}
.otg-top-nav-control:hover{{color:#F5F7FA!important;background:rgba(255,255,255,.045);border-color:transparent;text-decoration:none!important;transform:none;text-shadow:0 0 14px rgba(255,255,255,.10)}}
.otg-top-nav-control:focus-visible,.otg-nav-dropdown a:focus-visible{{outline:none;color:#FFFFFF!important;background:rgba(255,255,255,.075);text-decoration:none!important;text-shadow:0 0 16px rgba(255,255,255,.14)}}
.otg-nav-analytics{{position:relative}}.otg-nav-analytics>summary{{list-style:none}}.otg-nav-analytics>summary::-webkit-details-marker{{display:none}}.otg-top-nav-control.active,.otg-nav-analytics>summary.active{{color:#FFFFFF!important;border-color:transparent;border-bottom:1px solid transparent;background:rgba(255,255,255,.065);text-decoration:none!important;text-shadow:0 0 16px rgba(255,255,255,.12)}}
