...
@media(max-width:768px){.top-item-profile-card{display:block;width:calc(100vw - 24px);max-width:none;padding:14px}.top-item-profile-visual{width:100%;max-width:none;margin:0 0 14px}.top-item-profile-name{font-size:24px}.top-item-profile-stats{grid-template-columns:1fr}.top-item-profile-metric span,.top-item-profile-metric b{white-space:nowrap}}
