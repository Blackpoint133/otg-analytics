...
</style>''' + '''<style>.top-item-profile-name:link,.top-item-profile-name:visited,.top-item-profile-name:hover,.top-item-profile-name:focus,.top-item-profile-name:active{color:#FFFFFF;text-decoration:none}</style>'''
