...
@media(max-width:768px){.top-item-profile-card{display:block;width:calc(100vw - 24px);max-width:none;padding:14px}.top-item-profile-visual{width:100%;max-width:300px;margin:0 auto 14px}.top-item-profile-name{font-size:24px}.top-item-profile-stats{grid-template-columns:1fr}.top-item-profile-metric span,.top-item-profile-metric b{white-space:nowrap}}
...
</style>''' + '''<style>.top-item-profile-filter-rank{color:#FF003A !important}.top-item-profile-global-rank{color:#C8C8CD !important}.top-item-profile-name:link,.top-item-profile-name:visited,.top-item-profile-name:hover,.top-item-profile-name:focus,.top-item-profile-name:active{color:#FFFFFF !important;text-decoration:none !important}</style>'''
