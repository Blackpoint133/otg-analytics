...
def render_trader_table(rows: list[dict[str, Any]]) -> None:
    ...
    css = css.replace("box-sizing:border-box;background:#303035;", "box-sizing:border-box;border:1px solid #303035;background:#050505;")
    ...
    css = css.replace(".trader-profile-card{background:#303035} ", "")
