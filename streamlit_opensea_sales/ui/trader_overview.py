...
def render_trader_table(rows: list[dict[str, Any]]) -> None:
    ...
    css = f"""<style>.trader-table-scroll{{overflow-x:auto;width:100%;margin:16px 0}}.trader-table{{width:100%;min-width:1120px;border-collapse:collapse;background:#000;border:1px solid #FF003A;font-family:'Space Mono',monospace;font-size:11px}}.trader-table thead{{background:#0a0a0a;border-bottom:2px solid #FF003A}}.trader-table th{{color:#FF003A;padding:10px 8px;text-align:left;text-transform:uppercase;letter-spacing:1px;font-size:10px;white-space:nowrap}}.trader-table td{{color:#FFF;padding:8px;border-bottom:1px solid rgba(255,255,255,.04);white-space:nowrap}}.trader-table tbody tr:hover{{background:#0a0a0a}}.trader-table tbody tr.trader-row-selected{{background:rgba(255,0,58,.07);box-shadow:inset 3px 0 0 #FF003A}}.trader-table .earned-value{{color:{EARNED_COLOR};font-weight:700}}.trader-table .invested-value{{color:{INVESTED_COLOR};font-weight:700}}.trader-table .sold-value{{color:{SOLD_COLOR};font-weight:700}}.trader-profile-trigger{{display:inline-flex;align-items:center;gap:8px;position:relative;cursor:default}}.trader-avatar{{display:inline-block;flex:0 0 auto;background-image:var(--trader-remote-avatar,none),var(--trader-fallback-avatar);background-size:cover;background-position:center;background-repeat:no-repeat;border-radius:50%;background-color:#111;border:1px solid #FF003A}}.trader-avatar-small{{width:28px;height:28px}}.trader-avatar-large{{width:44px;height:44px}}.trader-profile-secondary{{display:block;color:#C8C8CD;font-size:10px;font-weight:400}}.trader-profile-card{{display:none;position:absolute;z-index:1000;left:0;bottom:calc(100% + 8px);top:auto;width:min(760px,calc(100vw - 32px));white-space:normal;background:#080808;border:1px solid #FF003A;padding:16px;color:#FFF;box-shadow:0 8px 24px #000;line-height:1.35}}.trader-profile-card::before{{content:"";position:absolute;left:0;right:0;height:8px;bottom:-8px}}.trader-table tbody tr:nth-child(-n+8) .trader-profile-card{{top:calc(100% + 8px);bottom:auto}}.trader-table tbody tr:nth-child(-n+8) .trader-profile-card::before{{top:-8px;bottom:auto}}.trader-profile-trigger:hover .trader-profile-card{{display:block}}.trader-profile-card-grid{{display:grid;grid-template-columns:minmax(220px,42%) minmax(0,1fr);gap:18px;align-items:start}}.trader-profile-avatar{{width:100%;aspect-ratio:1/1;background:#101010}}.trader-profile-card .trader-avatar-large{{display:block;width:100%;height:100%;aspect-ratio:1/1;border-radius:0;border:0;background-size:cover}}.trader-profile-content{{min-width:0}}.trader-profile-identity{{display:flex;align-items:center;gap:10px;margin-bottom:8px}}.trader-profile-identity strong{{display:block;color:#FFF;font-size:18px}}.trader-profile-card a{{color:#FF003A;margin:7px 0;text-decoration:none}}.trader-opensea-link{{display:inline-block}}.trader-profile-muted{{color:#C8C8CD;font-size:10px;overflow-wrap:anywhere}}.trader-profile-label{{color:#C8C8CD;font-size:9px;font-weight:700;letter-spacing:1px;margin-top:10px}}.trader-profile-bio{{color:#FFF;margin:5px 0 10px;overflow-wrap:anywhere;white-space:normal}}.trader-wallet-row{{display:flex;align-items:center;gap:8px;flex-wrap:wrap}}.trader-wallet-copy{{background:#0b0b0b;border:1px solid #303030;color:#FFF;padding:5px 7px;font:inherit;cursor:pointer}}.trader-wallet-copy span{{color:#FF003A;margin-left:10px}}.trader-profile-stats-title{{color:#FF003A;font-size:10px;font-weight:700;letter-spacing:1px;margin-top:14px}}.trader-profile-ranks{{border-top:1px solid #303030;margin-top:5px;padding-top:5px;font-size:10px}}.trader-profile-ranks div{{display:grid;grid-template-columns:minmax(70px,1fr) 44px minmax(100px,1fr);gap:6px;border:1px solid #303030;background:#0b0b0b;padding:5px 6px;margin:3px 0}}.trader-profile-ranks b{{color:#FFF}}.trader-profile-ranks em{{color:#C8C8CD;font-style:normal;text-align:right;overflow-wrap:anywhere}}@media (max-width:768px){{.trader-profile-card{{width:min(520px,calc(100vw - 24px));left:0}}.trader-profile-card-grid{{grid-template-columns:1fr}}.trader-profile-avatar{{max-width:260px}}}}</style><div class="trader-table-scroll"><table class="trader-table"><thead><tr>{''.join(f'<th>{c}</th>' for c in columns)}</tr></thead><tbody>{''.join(body)}</tbody></table></div>"""
