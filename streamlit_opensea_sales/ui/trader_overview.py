...
def render_trader_table(rows: list[dict[str, Any]]) -> None:
    ...
    css = f"""<style>.trader-table-scroll{{overflow-x:auto;width:100%;margin:16px 0}}.trader-table{{width:100%;min-width:1120px;border-collapse:collapse;background:#000;border:1px solid #FF003A;font-family:'Space Mono',monospace;font-size:11px}}.trader-table thead{{background:#0a0a0a;border-bottom:2px solid #FF003A}}.trader-table th{{color:#FF003A;padding:10px 8px;text-align:left;text-transform:uppercase;letter-spacing:1px;font-size:10px;white-space:nowrap}}.trader-table td{{color:#FFF;padding:8px;border-bottom:1px solid rgba(255,255,255,.04);white-space:nowrap}}.trader-table tbody tr:hover{{background:#0a0a0a}}.trader-table tbody tr.trader-row-selected{{background:rgba(255,0,58,.07);box-shadow:inset 3px 0 0 #FF003A}}.trader-table .earned-value{{color:{EARNED_COLOR};font-weight:700}}.trader-table .invested-value{{color:{INVESTED_COLOR};font-weight:700}}.trader-table .sold-value{{color:{SOLD_COLOR};font-weight:700}}.trader-profile-trigger{{display:inline-flex;align-items:center;gap:8px;position:relative;cursor:default}}.trader-avatar{{display:inline-block;flex:0 0 auto;background-image:var(--trader-remote-avatar,none),var(--trader-fallback-avatar);background-size:cover;background-position:center;background-repeat:no-repeat;border-radius:50%;background-color:#111;border:1px solid #FF003A}}.trader-avatar-small{{width:28px;height:28px}}.trader-avatar-large{{width:44px;height:44px}}.trader-profile-secondary{{display:block;color:#C8C8CD;font-size:10px;font-weight:400}}.trader-profile-card{{display:none;position:absolute;z-index:1000;left:0;bottom:calc(100% + 8px);top:auto;width:min(980px,calc(100vw - 40px));white-space:normal;background:#050505;clip-path:polygon(0 12px,12px 0,calc(100% - 12px) 0,100% 12px,100% calc(100% - 12px),calc(100% - 12px) 100%,12px 100%,0 calc(100% - 12px));padding:22px;color:#FFF;line-height:1.35;box-shadow:0 8px 24px #000}}.trader-profile-card::after{{content:"";position:absolute;inset:5px;z-index:-1;border:1px solid #2f2f35;pointer-events:none}}.trader-profile-card::before{{content:"";position:absolute;left:0;right:0;height:8px;bottom:-8px}}.trader-table tbody tr:nth-child(-n+8) .trader-profile-card{{top:calc(100% + 8px);bottom:auto}}.trader-table tbody tr:nth-child(-n+8) .trader-profile-card::before{{top:-8px;bottom:auto}}.trader-profile-trigger:hover .trader-profile-card{{display:block}}.trader-profile-card-grid{{display:grid;grid-template-columns:minmax(300px,42%) minmax(0,1fr);gap:24px;align-items:start}}.trader-profile-avatar{{width:100%;aspect-ratio:1/1;background:#101010;position:relative;overflow:hidden}}.trader-profile-card .trader-avatar-large{{display:block;width:100%;height:100%;aspect-ratio:1/1;border-radius:0;border:0;background-size:cover}}.trader-profile-avatar::before{{content:"OFF\\A THE\\A GRID";white-space:pre;color:#7b7b82;font-size:9px;line-height:1.05;letter-spacing:2px;position:absolute;left:10px;top:10px;z-index:1;pointer-events:none}}.trader-profile-avatar::after{{content:"TRADERS\\A BUILD\\A DIFFERENT";white-space:pre;color:#7b7b82;font-size:8px;line-height:1.05;letter-spacing:1px;position:absolute;right:10px;bottom:10px;text-align:right;z-index:1;pointer-events:none}}.trader-profile-content{{min-width:0;position:relative}}.trader-profile-content::before{{content:"TRADER\\A PROFILE";white-space:pre;position:absolute;right:0;top:-2px;color:#77777d;font-size:9px;line-height:1.1;letter-spacing:2px;text-align:right}}.trader-profile-identity{{display:flex;align-items:center;gap:10px;margin-bottom:18px;padding-right:92px}}.trader-profile-identity strong{{display:block;color:#FFF;font-size:32px;line-height:1.05;overflow-wrap:anywhere}}.trader-profile-card a{{color:#FF003A;margin:7px 0;text-decoration:none}}.trader-opensea-link{{display:inline-block;font-size:13px}}.trader-profile-muted{{color:#C8C8CD;font-size:10px;overflow-wrap:anywhere}}.trader-profile-label{{color:#C8C8CD;font-size:9px;font-weight:700;letter-spacing:1.5px;margin-top:10px}}.trader-profile-bio{{color:#FFF;margin:7px 0 14px;padding:12px 14px;border:1px solid #3a3a40;border-left:2px solid #FF003A;background:#090909;overflow-wrap:anywhere;white-space:normal;min-height:40px}}.trader-wallet-row{{display:flex;align-items:center;gap:8px;flex-wrap:wrap;padding:9px 10px;border:1px solid #3a3a40;border-left:2px solid #FF003A;background:#090909}}.trader-wallet-copy{{display:flex;align-items:center;justify-content:space-between;gap:16px;min-width:250px;background:transparent;border:0;color:#FFF;padding:2px;font:inherit;cursor:pointer;text-align:left}}.trader-wallet-copy:hover{{color:#FFF}}.trader-wallet-copy span{{color:#FF003A;margin-left:0}}.trader-wallet-short{{overflow-wrap:anywhere}}.trader-profile-stats-title{{display:flex;justify-content:space-between;color:#FF003A;font-size:10px;font-weight:700;letter-spacing:1.5px;margin-top:20px;border:1px solid #FF003A;border-bottom:0;padding:8px 10px}}.trader-profile-stats-title::after{{content:"ONCHAIN PERFORMANCE";color:#77777d;font-weight:400}}.trader-profile-ranks{{border:1px solid #FF003A;margin-top:0;padding:6px 8px;font-size:10px;background:#080808}}.trader-profile-ranks div{{display:grid;grid-template-columns:12px minmax(70px,1fr) 44px minmax(100px,1fr);gap:7px;align-items:center;border:1px solid #303035;border-left:2px solid #FF003A;background:#0b0b0b;padding:7px 8px;margin:4px 0;min-height:22px}}.trader-profile-ranks div::before{{content:"//";color:#FF003A}}.trader-profile-ranks b{{color:#FFF;border-right:1px solid #FF003A;padding-right:7px}}.trader-profile-ranks em{{color:#C8C8CD;font-style:normal;text-align:right;overflow-wrap:anywhere}}@media (max-width:768px){{.trader-profile-card{{width:min(560px,calc(100vw - 24px));left:0}}.trader-profile-card-grid{{grid-template-columns:1fr}}.trader-profile-avatar{{max-width:300px}}.trader-profile-identity strong{{font-size:24px}}.trader-profile-content::before{{font-size:8px}}}}</style><div class="trader-table-scroll"><table class="trader-table"><thead><tr>{''.join(f'<th>{c}</th>' for c in columns)}</tr></thead><tbody>{''.join(body)}</tbody></table></div>"""
