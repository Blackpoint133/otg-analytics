...
def _display_source(value) -> str:
    return {"item": "ITEM", "market": "MARKET", "top_items": "TOP ITEMS", "trader": "TOP TRADERS", "top_traders": "TOP TRADERS", "roadmap": "ROADMAP", "ecosystem": "ECOSYSTEM", "unknown": "UNKNOWN"}.get(str(value).strip().lower(), "UNKNOWN")
